...
docker exec zedbox /scripts/local_ni.sh 1 10.10.1.0/24   10.10.1.1/24   10.10.1.50,10.10.1.150,60m     ${veth_net_prefix}.1/30 ${veth_net_prefix}.2/30  eth0
docker exec zedbox /scripts/local_ni.sh 2 192.168.1.0/24 192.168.1.1/24 192.168.1.50,192.168.1.150,60m ${veth_net_prefix}.5/30 ${veth_net_prefix}.6/30  eth0
docker exec zedbox /scripts/local_ni.sh 3 10.10.1.0/24   10.10.1.1/24   10.10.1.50,10.10.1.150,60m     ${veth_net_prefix}.9/30 ${veth_net_prefix}.10/30 eth1
...
docker exec zedbox /scripts/switch_ni.sh 4 nbu1x4 eth2
