...
# veth_net_prefix=169.254.100 # OK
veth_net_prefix=244.1.1       # OK
...
declare -a containers=("gw" "cloud1" "cloud2" "zedbox" "app1" "app2" "app3" "app4" "app5" "app6")
...
docker exec zedbox /scripts/ni.sh 1 10.10.1.0/24   10.10.1.1/24   10.10.1.50,10.10.1.150,60m     ${veth_net_prefix}.1/30  ${veth_net_prefix}.2/30  eth0
docker exec zedbox /scripts/ni.sh 2 192.168.1.0/24 192.168.1.1/24 192.168.1.50,192.168.1.150,60m ${veth_net_prefix}.5/30  ${veth_net_prefix}.6/30  eth0
docker exec zedbox /scripts/ni.sh 3 10.10.1.0/24   10.10.1.1/24   10.10.1.50,10.10.1.150,60m     ${veth_net_prefix}.9/30  ${veth_net_prefix}.10/30 eth1
docker exec zedbox /scripts/ni.sh 4 10.10.10.0/24  10.10.10.1/24  10.10.10.50,10.10.10.150,60m   ${veth_net_prefix}.13/30 ${veth_net_prefix}.14/30 eth1
docker exec zedbox /scripts/ni.sh 5 10.10.10.0/24  10.10.10.1/24  10.10.10.50,10.10.10.150,60m   ${veth_net_prefix}.17/30 ${veth_net_prefix}.18/30 eth2
